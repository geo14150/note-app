...
let addNoteModal, addNoteBtn, confirmDeleteBtn, cancelDeleteBtn, filterSelect, searchInput, closeModalBtn,noteForm, notesContainer,emptyState,confirmModal;
...
function renderNotes(notesToRender = notes) {
    const notesContainer = document.getElementById("notesContainer"); // Access the element inside the function or define globally/in listener
...
function getTagClass(tag) {
    ...
    return classes[tag] ? `note-tag ${classes[tag]}` : 'note-tag';
}
